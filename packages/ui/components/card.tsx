...
const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-2xl border border-border/50 bg-card text-card-foreground shadow-lg ring-1 ring-slate-900/5 dark:ring-white/10 transition-all duration-300 hover:shadow-xl hover:border-border',
      className
    )}
    {...props}
  />
